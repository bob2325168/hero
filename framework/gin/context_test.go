...
import (
	...
	"github.com/bob2325168/gohero/framework/gin/binding"

	"github.com/gin-contrib/sse"
	"github.com/golang/protobuf/proto"
	"github.com/stretchr/testify/assert"

	testdata "github.com/bob2325168/gohero/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/bob2325168/gohero/framework/gin.handlerNameTest$", c.HandlerName())
}
