...
type Trace interface {
	// // SetTraceIDService set TraceID generator, default heroIDGenerator
	// SetTraceIDService(IDService)
	// // SetTraceIDService set SpanID generator, default heroIDGenerator
