...
func NewHeroTraceService(params ...interface{}) (interface{}, error) {
	...
	return &HeroTraceService{idService: idService}, nil
}

// WithTrace register new trace to context
func (t *HeroTraceService) WithTrace(c context.Context, trace *contract.TraceContext) context.Context {
...
func (t *HeroTraceService) GetTrace(c context.Context) *contract.TraceContext {
	if ginC, ok := c.(*gin.Context); ok {
...
func (t *HeroTraceService) StartSpan(tc *contract.TraceContext) *contract.TraceContext {
...
func (t *HeroTraceService) ToMap(tc *contract.TraceContext) map[string]string {
	m := map[string]string{}
	if tc == nil {
		return m
	}
