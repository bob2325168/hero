...
// NewHeroSingleLog params sequence: level, ctxFielder, Formatter, map[string]interface(folder/file)
func NewHeroSingleLog(params ...interface{}) (interface{}, error) {
